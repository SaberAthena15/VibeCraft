...
export default {
  ...
  CODE_GEN_PROMPT: dedent`
    ...
    **Dependencies to Use:**  
    ...
    Do not create an App.jsx file. There is an App.js file in the project structure, rewrite it.
    ...
    - Do not use backend or database related code.
  `,
  ...
  ENHANCE_PROMPT_RULES: dedent`
    ...
    1. Making it more specific and detailed but concise.
    ...
    6. Do not use backend or database-related content.
